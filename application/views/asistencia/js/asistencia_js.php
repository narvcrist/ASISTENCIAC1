...
jQuery(document).ready(function(){
   ...
   var numero='<?php echo !empty($sol->ASIS_SECUENCIAL) ? prepCampoMostrar($sol->ASIS_SECUENCIAL) : null ; ?>';
...
jQuery("#ASIS_HORAINICIO,#ASIS_HORAFIN").datepicker({
        dateFormat: 'dd-mm-yy',
		timeFormat: 'hh:mm:ss'
...
$("#fasistencia").validate({
       ...
       //submit handler
       rules:{
			"ASIS_HORAINICIO":{required:true},
			"ASIS_HORAFIN":{required:true},
             }
     });     
});
</script>